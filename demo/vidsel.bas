...
1950 I=1 : GOTO 2000
1960 FOR I=1 TO NV
1970 PRINT @ 70+I*32, I;"- ";VF$(I);
1980 NEXT I
1990 IF NV = 8 THEN GOTO 2060
2000 PRINT @ 70+I*32, I;"- CATEGORY MENU";
2010 PRINT @ 135+I*32, "CHOICE";
2020 INPUT CH : IF CH = I THEN RETURN
2030 IF CH < 1 OR CH > I+1 THEN GOTO 1920 ELSE VD=VF(CH)
2040 GOSUB 2160
2050 GOTO 1920
2060 PRINT @ 358, I;"- MORE VIDEOS";
2070 PRINT @ 389, I+1;"- CATEGORY MENU";
2080 PRINT @ 455, "CHOICE";
